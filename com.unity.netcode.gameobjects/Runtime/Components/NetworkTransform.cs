...
namespace Unity.Netcode.Components
{
    ...
    public class NetworkTransform : NetworkBehaviour
    {
        ...
        protected virtual Transform SyncedTransform { get; private set; }
        ...
        {
            SyncedTransform = transformToUse;
        ...
        private bool CheckForStateChange(ref NetworkTransformState networkState, bool isSynchronization = false, ulong targetClientId = 0, bool forceState = false)
        {
...
#if COM_UNITY_MODULES_PHYSICS || COM_UNITY_MODULES_PHYSICS2D
            var position = m_UseRigidbodyForMotion ? m_NetworkRigidbodyInternal.GetPosition() : InLocalSpace ? SyncedTransform.localPosition : SyncedTransform.position;
            var rotation = m_UseRigidbodyForMotion ? m_NetworkRigidbodyInternal.GetRotation() : InLocalSpace ? SyncedTransform.localRotation : SyncedTransform.rotation;
            ...
            //}
#else
            var position = InLocalSpace ? SyncedTransform.localPosition : SyncedTransform.position;
            var rotation = InLocalSpace ? SyncedTransform.localRotation : SyncedTransform.rotation;
            var positionThreshold = Vector3.one * PositionThreshold;
            var rotationThreshold = Vector3.one * RotAngleThreshold;
#endif
            ...
            {
                var localScale = SyncedTransform.localScale;
                if (!UseHalfFloatPrecision)
                {
        ...
        private void ResetInterpolatedStateToCurrentAuthoritativeState()
        {
            ...
            m_RotationInterpolator.ResetTo(SyncedTransform.parent, rotation, serverTime);

            m_ScaleInterpolator.ResetTo(SyncedTransform.parent, SyncedTransform.localScale, serverTime);
        }
        ...
        public void SetState(Vector3? posIn = null, Quaternion? rotIn = null, Vector3? scaleIn = null, bool teleportDisabled = true)
        {
            ...
            Vector3 scale = scaleIn ?? SyncedTransform.localScale;
